...
class _HomeScreenState extends State<HomeScreen> {
  Future<void> _loadResources() async {
    await Get.find<HomeController>().getAllPosts();
    await Get.find<HomeController>().getAllStories();
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              splashRadius: 20,
              onPressed: () async {
                // if (Get.find<ChatController>().myChat != null) {
