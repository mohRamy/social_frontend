      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: isFriend == 1 || isPendingFollowers == 1 ? Colors.white : colorPrimary,
              ...
              children: [
                Column(
                  children: [
                    ...
                    TextCustom(text: 'Post',  fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: '343',  fontSize: 22, fontWeight: FontWeight.w500),
                    TextCustom(text: 'Siguiendo', fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: '3434',  fontSize: 22, fontWeight: FontWeight.w500),
                    TextCustom(text: 'Seguidores', fontSize: 17, color: Colors.grey),
                  ],
                ),
